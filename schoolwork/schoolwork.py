...
class student(osv.osv):
    ...
    _description = "学生"
    _columns = {
        "number":fields.char("学号",required=True,readonly=True),
        'classsroom_id':fields.many2one('classroom',string=u'班级'),
    }
...
class teacher(osv.osv):
    ...
    _description = u"老师"
    _columns = {
        "number":fields.char("工号",required=True,readonly=True),
    }
